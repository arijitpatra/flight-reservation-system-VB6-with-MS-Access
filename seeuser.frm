...
Dim rsPatient2 As New ADODB.Recordset
...
Set DataGrid1.DataSource = res
 ...
 con2.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\arijit\FRS1\database\FRS DB.mdb;Persist Security Info=False"
 con2.Open
 
 res2.Open "select * from guest", con2, adOpenStatic, adLockOptimistic

Set DataGrid2.DataSource = res2
